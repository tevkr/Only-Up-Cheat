namespace OnlyUpCheat.Core
{
    internal static class Config
    {
        ...
        public static (int Pointer, int[] Offsets) PlayerXCoord = (0x0745D910, new int[] { 0x120, 0x198, 0x260 });
        public static (int Pointer, int[] Offsets) PlayerYCoord = (0x0745D910, new int[] { 0x120, 0x198, 0x268 });
        public static (int Pointer, int[] Offsets) PlayerZCoord = (0x0745D910, new int[] { 0x120, 0x198, 0x270 });
